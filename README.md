...
This repository contains source code for ALX's **simple_shell**. It is an imitation of the shell. It is executable  using GCC and will execute a simple shell that can be used for some basic commands and programs data most commonly allocated section in the /bin/ folder.
...
Git: [Wambui Gachora](https://github.com/wambuBObo), [Benjamin Otieno](https://github.com/JaminBenjamins)
